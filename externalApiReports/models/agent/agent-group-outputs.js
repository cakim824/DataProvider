...
const getAgentGroupOutputs = async ({ date_unit, tenant_key, site_cd, group_key, start_date, end_date, start_time, end_time, inbound_type_keys, outbound_type_keys, internal_type_keys }) => {
    ...
    SELECT 
            ...
            , LEFT(DT_KEY,10) AS DATE_KEY, (CASE WHEN LEN(X.DT_KEY) = 16 THEN RIGHT(DT_KEY, 5) ELSE '' END) AS TIME_KEY, GROUP_NAME
